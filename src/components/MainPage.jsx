...
const MainPage = ({ queryString }) => {
  ...
  const submitHandler = (e) => {
    ...
    useGetQueryData(queryString, setQResponse, setTempQResponse, defaultDisplayLimit);
    limit.current.value = defaultDisplayLimit;

  };

  const limitChangeHandler = () => {
    setTempQResponse(qResponse.filter((ele, index) => {
    ...
    <div className="maindiv">
      ...
      <div className="sidebar">
        ...
        >
          ...
          <input type="number" name="numRows" id="numRows" step="1" min="1" defaultValue={defaultDisplayLimit} ref={limit} onChange={limitChangeHandler}/>
